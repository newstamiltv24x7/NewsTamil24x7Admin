...
export async function POST(request) {
  try {
    ...
    // 2. batchSize() - Limit in-memory data
    // 3. lean() - Return plain objects
    ...
    console.error("Error in POST /api/v1/web/news/world:", err.message);
    ...
    return NextResponse.json({
      appStatusCode: 0,
      message: "",
      payloadJson: encryptCryptoResponse(emptyResult),
      error: "",
    });
  }
}