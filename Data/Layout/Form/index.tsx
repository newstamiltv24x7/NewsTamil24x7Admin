...
export const TooltipInitialValue: TooltipValidationProp = {
  firstname: "",
  lastname: "",
  username: "",
  city: "",
...
export const TooltipValidationStateList = [
  "U.K",
  "India",
  "Thailand",
  "Newyork",
...
export const ValidationFormInitialValue: FormValidationProp = {
  firstname: "",
  password: "",
  state: "",
  city: "",
...
export const ValidationFormStateList = [
  "Choose...",
  "U.K",
  "India",
  "Thailand",
...
export const SizingFormDataList = [
  "What's Your Hobbies",
  "Kho-kho",
  "Reading Books",
  "Creativity",
...
export const FlateStyleDataList = [
  "Landscape",
  "Portrait",
  "Oil Painting",
  "Abstract art",
...
export const RaisedColorDataList = [
  "Red",
  "Yellow",
  "Orange",
  "White",
...
export const ButtonWithDropForth = [
  "To-Do",
  "FAQ",
  "Knowledgebase",
  "Support Ticket",
...
export const DefaultFormData = [
  {
    ...
    digits: "50 INR",
    shipingText:
      "Estimated 2 Day Shipping ( Duties end tax may be due delivery )",
  },
  {
    id: 2,
    color: "secondary",
    ...
    digits: "100 INR",
    shipingText:
      "Estimated 1 Day Shipping ( Duties end tax may be due delivery )",
  },
];
...
export const InlineStyeDataList = [
  ...
  },
  {
    ...
    digits: "100 INR",
    shipingText:
      "Estimated 1 Day Shipping ( Duties end tax may be due upon delivery )",
  },
  {
    id: 3,
    color: "secondary",
    ...
    child: [
      {
        ...
        digits: "50 INR",
        spanText:
          "Estimated 10 to 15 Day Shipping ( Duties end taxes may be due delivery )",
      },
      {
        id: 2,
        color: "secondary",
        ...
        digits: "100 INR",
        spanText:
          "Estimated 10 to 12 Day Shipping ( Duties end tax may be due delivery )",
      },
      {
        id: 3,
        color: "success",
        ...
        digits: "80 INR",
        spanText:
          "Estimated 3 to 5 Day Shipping ( Duties end taxes may be due delivery )",
      },
      {
        id: 4,
        color: "info",
        ...
        digits: "Free",
        spanText:
          "Estimated 3 to 5 Day Shipping ( Duties end taxes may be due upon delivery )",
        check: true,
      },
    ],
  },
    ...
    child: [
      {
        ...
        digits: "50 INR",
        spanText:
          "Estimated 5 Day Shipping ( Duties end taxes may be due delivery )",
      },
      {
        id: 2,
...
export const DisableOutlineSwitchDataList = [
  "primary",
  "secondary",
  "success",
  "danger",
