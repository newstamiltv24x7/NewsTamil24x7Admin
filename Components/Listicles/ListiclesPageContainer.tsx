...
function ListiclesPageContainer() {
  ...
  const GetAllListiclesList = async () => {
    ...
    const results = await getAllListiclesListApi(body);
  ...
  const statusUpdate =async(id: any  , val: any ) =>{
    ...
    if (results?.appStatusCode !== 0) {
      ...
      setLoader(false);
      if(val === 1){
        toast.success("This Listicle is Active!");
      }else{
        toast.error("This Listicle is In-Active!");
      }
  ...
  const handleDeleteListicles = async (id: string) => {
    setDeletePop(false);
    const results = await deleteListicleApi(id);
    if (results?.appStatusCode !== 0) {
      toast?.error(results?.error);
    } else {
        ...
        <Col sm="12">
          <Card>
            <Box className="d-flex justify-content-between align-items-center">
              ...
              <Box pr={2}>
                <Link href={`/${i18LangStatus}/listicles/create-listicle`}>
                  <Button
                    sx={{
                      bgcolor: "#fe6a49",
                      color: "#fff",
                        ...
                        <tr key={index}>
                          ...
                          <td align="left">
                            ...
                            >
                              ...
                              <>
                                <Link
                                  href={`/${i18LangStatus}/listicles/edit-listicle/${row.c_listicles_id}`}
                                >
...
export default ListiclesPageContainer;
