...
const YoutubePageContainer = () => {
  ...
  const AddYouTubeLinkCall = async () => {
    let body = {
      c_live_stream_category_id: "17146c268476",
  ...
  const onDragEnd = async (result) => {
    ...
    let results = await youtubeStreamOrderApi({
      ...
      // n_updated_order_id: reorderedItem.c_url_order_id,
      // n_current_order_id: adList[result.destination.index]?.c_url_order_id,
      // c_updated_url_id: reorderedItem?.c_url_id,
      // c_current_url_id: adList[result.destination.index]?.c_url_id,
    });
                      ...
                      <Table responsive className="table-wrapper">
                        <thead style={{ background: "#000" }}>
                          <tr>
                            ...
                            <th style={{ color: "#fff", width: 400 }}>Live Video Title</th>
