...
import AddYoutubeShortsLink from "./AddYoutubeShortsLink";
...
const YoutubeShortsPageContainer = () => {
  ...
  const statusUpdate =async(id  , val ) =>{
    ...
    if (results?.appStatusCode !== 0) {
      ...
      setLoader(false);
      if(val === 1){
        toast.success("This Shorts Video is Active!");
      }else{
        toast.error("This Shorts Video is In-Active!");
      }
                      ...
                      <Table responsive className="table-wrapper">
                        <thead style={{ background: "#000" }}>
                          <tr>
                            ...
                            <th style={{ color: "#fff", width: 400 }}>Shorts Title</th>
...
export default YoutubeShortsPageContainer;
