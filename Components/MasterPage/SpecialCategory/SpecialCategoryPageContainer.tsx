...
import SpecialCategoryPage from "./SpecialCategoryPage";
...
import AddSpecialCategoryPop from "./AddSpecialCategoryPop";

const SpecialCategoryPageContainer = () => {
  ...
  const onDragEnd = (result: any) => {
    ...
    const body = {
        ...
        c_spl_category_order: categoryArr[result.destination.index]?.c_spl_category_order,
      };
...
export default SpecialCategoryPageContainer;
